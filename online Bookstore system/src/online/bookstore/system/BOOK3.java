...
public class BOOK3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("HALF GIRLFRIEND");
        ...
        jLabel7.setText("HALF GIRLFRIEND");

        jLabel8.setText("CHETAN BAGGAT");

        jLabel9.setText("456");

        jLabel10.setText("Rupa Publication India");

        jLabel11.setText("SUMMARY");

        jTextArea3.setColumns(20);
        jTextArea3.setRows(5);
        jTextArea3.setText("-Roundtrip airfare for economy class with taxes\n \n-Accommodation for 3 nights in Port Blair\n \n-Accommodation for 2 nights in Havelock\n \n-Meals: Daily Breakfast (except on the arrival day) \n \n-Standard package includes all transfers and sightseeing by shared AC vehicle in Port Blair & Havelock.\n \n-Entrance fees at all monuments as per itinerary; road taxes, parking fee, fuel charges, interstate taxes and portage at all hotels\n \n-Snorkelling at Elephant Beach(Havelock), subject to operations\n \n-Services of a MMT Tour Manager at the destination. ");
